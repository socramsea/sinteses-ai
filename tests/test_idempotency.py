"""Derivação do job_id (app/api/schemas.py).

O id é hash do payload normalizado: mesma intenção -> mesmo job, o que sustenta
a idempotência do POST /jobs sem tabela de deduplicação.
"""
